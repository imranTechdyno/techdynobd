<div class="py_100 customer_testimonie_bg">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="position-relative mb-5 mb-xl-0 customer_img_bg">
                                    <img src="<?php echo e(getFile('banner', 'banner.png')); ?>" alt="Victor Gbenga Afolabi"
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <div class="position-relative mb-5 mb-xl-0 testi_img">
                                    <img src="asset/img/karma.png" alt="Karma"
                                        class="img-fluid position-relative z-two">
                                    <div class="position-absolute start-50 testi_play top-50 translate-middle z-two">
                                        <a href="https://www.youtube.com/watch?v=Mx-7oKG3h8M"
                                            class="vdo-link align-items-center play_bg d-flex justify-content-center rounded-circle play_button pulse-anim2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16.447" height="25.756"
                                                viewBox="0 0 16.447 25.756">
                                                <path id="Path_493" data-name="Path 493"
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex mb-4 ms-0 ms-lg-5">
                                    <div class="d-block">
                                        <h5 class="fw_600 mb-1">Karma Dorji</h5>
                                        <div class="fw-normal text-bdtask">Advisor Edruk</div>
                                    </div>
                                </div>
                                <div class="d-block ms-0 ms-lg-5">
                                    <p>Bdtask, Inc. is one of my prime choice and trustable company for any customize
                                        software solution. They have a strong commitment to deliver their project and
                                        they have a good behavior to their clients. I came to visit their Bangladesh
                                        office and they have a good office with big space and environment. </p>
                                </div>
                            </div>
                        </div>
                    </div>
