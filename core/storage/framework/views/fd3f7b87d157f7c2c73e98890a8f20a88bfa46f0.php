        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a
                        href="<?php echo e(route('admin.home')); ?>"><?php echo e(__('Dashboard')); ?></a>
                </div>
            </div>
        </div>
        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?php echo e(route('admin.language.translator', $lang->short_code)); ?>"
                                            class="btn btn-primary"><?php echo e('Transalator'); ?></a>
                                    </td>
                                </tr>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tdbdltd\core\resources\views/backend/language/index.blade.php ENDPATH**/ ?>