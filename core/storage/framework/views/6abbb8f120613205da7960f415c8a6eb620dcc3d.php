        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="<?php echo e(route('admin.frontend.pages')); ?>"><?php echo e(__('Pages')); ?></a>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <form action="" method="POST" class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">       
                                                <p class="text-capitalize"><?php echo e(__('Select The Section You Want to add your page')); ?></p>
                                                        ...
                                                        <div class="d-flex justify-content-start flex-wrap">
                                                            <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $sec): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="col-md-3 my-2 selectable"
                                                                    ...
                                                                    <div class="p-3 <?php echo e(in_array($key, $page->sections) ? 'bg-gradient-success' : 'bg-gradient-primary'); ?> text-center">
                                            ...
                                            <div
                                                class="form-group <?php echo e($page->name == 'home' ? 'col-md-6' : 'col-md-6'); ?>">
                                            ...
                                            <div
                                                class="form-group col-md-6 custom-section <?php echo e($page->custom_section_data != null ? '' : 'd-none'); ?>">

                                                <label for=""><?php echo e(__('Custom Section')); ?></label>
                                                <textarea name="custom_section" id="" cols="30" rows="5" class="form-control summernote"><?php echo e($page->custom_section_data ?? old('custom_section')); ?></textarea>
...
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tdbdltd\core\resources\views/backend/frontend/page_edit.blade.php ENDPATH**/ ?>