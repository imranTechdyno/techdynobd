...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body ">
                                ...
                                <form action="" method="POST" class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <p class="text-capitalize"><?php echo e(__('For Nav Bar Select The Section You Want to
                                                add your page ')); ?></p>
                                            ...
                                            <div class="d-flex justify-content-start flex-wrap ">
                                                ...
                                                <div class="col-md-3 my-2 selectable" id="<?php echo e($key); ?>" data-clicked="on"
                                                    data-section="<?php echo e($key); ?>">
                                                    <div class="p-3 bg-gradient-primary text-center">
                                                        <span class="text-white counter">
                                                        </span>
                                                        <span class="text-white text-center"><?php echo e(frontendFormatter($key)); ?>
                                        ...
                                        <div class="form-group col-md-4 custom-section d-none">
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary float-right"><?php echo e(__('Add Page')); ?></button>
                                        </div>
            ...
            <?php $__env->stopPush(); ?>
<?php echo $__env->make('backend.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tdbdltd\core\resources\views/backend/frontend/pages_create.blade.php ENDPATH**/ ?>