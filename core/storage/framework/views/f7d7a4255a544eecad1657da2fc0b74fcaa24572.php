                        ...
                        <ul class="dropdown-menu">
                            ...
                            <?php if(auth()->guard('admin')->user()->can('admin_user_add')): ?>
                                <li class="<?php echo e(@$adminAddActive); ?>">
                                    <a class="nav-link"
                                        href="<?php echo e(route('admin.create')); ?>"><?php echo e(__('Create Admin')); ?></a>
                                </li>
                            <?php endif; ?>
                        </ul>
                    </li>
                        ...
                        <ul class="dropdown-menu">
                            <?php if(auth()->guard('admin')->user()->can('role_list')): ?>
                                <li class="<?php echo e(@$role_list_active); ?>">
                                    <a class="nav-link"
                                        href="<?php echo e(route('admin.roles.index')); ?>"><?php echo e(__('Role List')); ?></a>
                                </li>
                            <?php endif; ?>
...
<?php /**PATH C:\laragon\www\tdbdltd\core\resources\views/backend/layout/sidebar.blade.php ENDPATH**/ ?>