<!-- Glance Start-->
<div class="glance bg_grad2 py_100 position-relative">
    <div class="container-md">
        ...
        <div class="row g-3">
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="bg-white d-block py-4 shadow-sm text-center wow fadeInUp translateOnHover">
                    <div class="mh_45">
                        <svg id="Group_334" data-name="Group 334" xmlns="http://www.w3.org/2000/svg" width="41.375"
                            ...
                            <path id="Path_472" data-name="Path 472"
                                ...
                                transform="translate(2134.485 -691.695)" fill="#37a001" />
                            <path id="Path_473" data-name="Path 473"
                                ...
                                transform="translate(1932.157 -981.764)" fill="#37a001" />
                            <path id="Path_474" data-name="Path 474"
                                ...
                                transform="translate(2072.14 -1226.546)" fill="#37a001" />
                            <path id="Path_475" data-name="Path 475"
                                ...
                                transform="translate(2072.136 -1019.669)" fill="#37a001" />
                            <path id="Path_476" data-name="Path 476"
                                ...
                                transform="translate(2072.108 -1122.375)" fill="#37a001" />
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-black"><span class="counter" data-count="50">0</span>+
                    </div>
                    <div>Projects</div>
                </div>
            </div>
                            ...
                            <g id="_2Jgj3q" data-name="2Jgj3q" transform="translate(3147.395 -519.695)">
                                <g id="Group_335" data-name="Group 335" transform="translate(-3147.395 519.695)">
                                    <path id="Path_477" data-name="Path 477"
                                        ...
                                        transform="translate(3147.395 -519.695)" fill="#37a001" />
                                </g>
                            </g>
                        </svg>
                    </div>
                            ...
                            <g id="zvwJUH" transform="translate(1075.783 366.593)">
                                <g id="Group_336" data-name="Group 336" transform="translate(-1075.783 -366.593)">
                                    <path id="Path_478" data-name="Path 478"
                                        ...
                                        transform="translate(1075.783 366.593)" fill="#37a001" />
                                </g>
                            </g>
                        </svg>
                    </div>
                            ...
                            <g id="_2MLMWq" data-name="2MLMWq" transform="translate(1332.433 328.542)">
                                <g id="Group_338" data-name="Group 338" transform="translate(-1332.433 -328.542)">
                                    <path id="Path_479" data-name="Path 479"
                                        ...
                                        transform="translate(1332.433 328.542)" fill="#37a001" />
                                </g>
                            </g>
                        </svg>
                    </div>
                    ...
                    <div class="mh_45">
                        <svg xmlns="http://www.w3.org/2000/svg" width="47.353" height="44.297"
                            ...
                            <path id="Path_60" data-name="Path 60"
                                ...
                                transform="translate(-0.927 -2.995)" fill="#37a001" />
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-black"><span class="counter" data-count="10">0</span>K+
                    </div>
                            ...
                            <g id="lBKXOS" transform="translate(1582.994 262.826)">
                                <g id="Group_339" data-name="Group 339" transform="translate(-1582.994 -262.826)">
                                    <path id="Path_480" data-name="Path 480"
                                        ...
                                        transform="translate(1544.107 219.924)" fill="#37a001" />
                                    <path id="Path_481" data-name="Path 481"
                                        ...
                                        transform="translate(1566.342 212.492)" fill="#37a001" />
                                    <path id="Path_482" data-name="Path 482"
                                        ...
                                        transform="translate(1539.092 262.826)" fill="#37a001" />
                                    <path id="Path_483" data-name="Path 483"
                                        ...
                                        transform="translate(1511.138 212.386)" fill="#37a001" />
                                    <path id="Path_484" data-name="Path 484"
                                        ...
                                        transform="translate(1567.003 255.91)" fill="#37a001" />
                                    <path id="Path_485" data-name="Path 485"
                                        ...
                                        transform="translate(1506.214 255.932)" fill="#37a001" />
                                    <path id="Path_486" data-name="Path 486"
                                        ...
                                        transform="translate(1582.994 206.564)" fill="#37a001" />
                                    <path id="Path_487" data-name="Path 487"
                                        ...
                                        transform="translate(1487.429 206.19)" fill="#37a001" />
                                    <path id="Path_488" data-name="Path 488"
                                        ...
                                        transform="translate(1483.835 234.832)" fill="#37a001" />
                                    <path id="Path_489" data-name="Path 489"
                                        ...
                                        transform="translate(1581.933 234.818)" fill="#37a001" />
                                    <path id="Path_490" data-name="Path 490"
                                        ...
                                        transform="translate(1549.706 235.522)" fill="#37a001" />
                                    <path id="Path_491" data-name="Path 491"
                                        ...
                                        transform="translate(1514.595 235.525)" fill="#37a001" />
                                </g>
                            </g>
                        </svg>
                    </div>
                    <div class="fs-2 fw-bold lh-1 mb-2 mt-3 text-black"><span class="counter" data-count="10">0</span>+
                    </div>
...
</div><?php /**PATH C:\xampp\htdocs\tdbdltd\core\resources\views/frontend/sections/at_a_glance.blade.php ENDPATH**/ ?>