<footer class="position-relative footer_bg">
        ...
        <div class="row pb-5 pt_80 position-relative">
            <div class="col-lg-6">
                <a class="f_logo" href="https://www.techdynobd.com/">
                    <img src="{{ getFile('logo', 'logo1.png') }}" alt="Techdyno Logo">
                </a>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container-md py-5 mb-3 bottom_line">
        ...
        <div class="row service_coun_img">
            <img src="{{ getFile('service_country', 'sc1.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc2.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc3.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc4.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc5.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc6.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc7.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc8.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc9.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc10.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc11.png') }}" alt="">
            <img src="{{ getFile('service_country', 'sc12.png') }}" alt="">            
            <img src="{{ getFile('service_country', 'sc13.png') }}" alt="">
        </div>
    </div>
