...
<script src="{{ asset('asset/frontend/js/jquery.flexslider-min.js') }}"></script>
...
<script src="{{ asset('asset/frontend/js/back-to-top.js') }}"></script>
<script src="{{ asset('asset/frontend/js/validate.js') }}"></script>
<script src="{{ asset('asset/frontend/js/subscribe.js') }}"></script>
<script src="{{ asset('asset/frontend/js/main.js') }}"></script>
<script src="{{ asset('asset/frontend/js/sticky.js') }}"></script>
