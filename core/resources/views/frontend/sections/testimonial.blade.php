                        ...
                        <div class="row align-items-center cp_pad">
                            <div class="col-lg-6">
                                <div class="position-relative mb-5 mb-xl-0 customer_img_bg">
                                    <img src="{{ getFile('banner', 'banner1.png') }}" alt="Victor Gbenga Afolabi"
                                ...
                                <img src="{{ getFile('icon', 'cp_icon2.png') }}" class="cp_icon2" alt="Customer Icon">
                            </div>
                            <div class="col-lg-6">
                                <div>
                                    <img src="{{ getFile('icon', 'cp_icon.png') }}" alt="comma">
                                </div>
