...
<div class="container-fluid contact_section">
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="row main_contact_part">
                <div class="col-lg-6">
                    <img src="{{ getFile('contact', 'contact.png') }}" class="contact_img" alt="contact">
                </div>
                ...
                <div class="col-lg-6 contact_form">
                    <form action="" method="post">
                        ...
                        <div class="form-group mt-4">
                            <input class="form-control pb" type="number" name="contac_no" placeholder="Contact No*">
                        </div>
                        <div class="form-group mt-4">
