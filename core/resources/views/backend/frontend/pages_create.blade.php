                                ...
                                <form action="" method="POST" class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <p class="text-capitalize">{{ __('For Nav Bar Select The Section You Want to
                                                add your page ') }}</p>
                                            ...
                                            <div class="d-flex justify-content-start flex-wrap ">
                                                ...
                                                <div class="col-md-3 my-2 selectable" id="{{ $key }}" data-clicked="on"
                                                    data-section="{{ $key }}">
                                                    <div class="p-3 bg-gradient-primary text-center">
                                                        <span class="text-white counter">
                                                        </span>
                                                        <span class="text-white text-center">{{ frontendFormatter($key)
                                                            }}
                                                        </span>
                                        ...
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-primary float-right">{{ __('Add Page')
                                                }}</button>
                                        </div>
