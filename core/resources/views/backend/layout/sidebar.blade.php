    ...
    <aside id="sidebar-wrapper">
        {{-- <div class="sidebar-brand">
            <a href="{{ route('admin.home') }}">
                ...
                @else
                <img class="img-fluid" src="{{ getFile('default', @$general->default_image) }}" alt="img" width="15%">
                @endif
            </a>
            <br>
        ...
        <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ @$navAdminActive }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ @$adminAddActive }}">
                        <a class="nav-link" href="{{ route('admin.create') }}">{{ __('Create Admin') }}</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ @$administration_active }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ @$role_add_active }}">
                        <a class="nav-link" href="{{ route('admin.roles.create') }}">{{ __('Role Create') }}</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li class="nav-item dropdown {{ @$navGeneralSettingsActiveClass }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ $ana }}"><a class="nav-link " href="{{ route('admin.general.analytics') }}">{{ __('Google Analytics')
                            }}</a>
                    </li>

                    <li>
                        <a class="nav-link" href="{{ route('admin.general.database') }}">{{ __('Database Backup') }}</a>
                    </li>
                    <li>
            ...
            <li class="nav-item dropdown {{ @$navManagePagesActiveClass }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li
                        class="@if (frontendFormatter($key) == frontendFormatter(@$activeClass)) active @else ' ' @endif">
