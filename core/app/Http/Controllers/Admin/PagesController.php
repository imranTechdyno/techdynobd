...
class PagesController extends Controller
{
    ...
    public function pageCreate()
    {
        ...
        return view('backend.frontend.pages_create',compact('navManagePagesActiveClass','pageTitle', 'sections'));
    }
    ...
    public function pageEdit(Request $request, Page $page)
    {
        ...
        return view('backend.frontend.page_edit',compact('navManagePagesActiveClass','pageTitle','page','sections'));
    }
