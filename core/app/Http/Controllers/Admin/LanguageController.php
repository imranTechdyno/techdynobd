...
class LanguageController extends Controller
{
    ...
    public function transalate(Request $request)
    {
       ...
       $subNavManageLanguageActiveClass = 'active';
       ...
       return view('backend.language.translate',compact('navManageLanguageActiveClass','subNavManageLanguageActiveClass','pageTitle','translators','languages'));
    }
